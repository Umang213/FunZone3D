			...
			{// begin catch(System.Reflection.AmbiguousMatchException)
				{
					...
					L_21 = VirtualFuncInvoker1< MethodInfoU5BU5D_tDF3670604A0AECF814A0B0BA09B91FBF0D6A3265*, int32_t >::Invoke(97 /* System.Reflection.MethodInfo[] System.Type::GetMethods(System.Reflection.BindingFlags) */, L_20, ((int32_t)56));
					V_5 = L_21;
					V_6 = 0;
					goto IL_01bb_1;
				}
...
IL_0154_1:
				...
				}
				{
					...
					NullCheck(L_40);
					bool L_42;
					L_42 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(21 /* System.Boolean System.Type::IsAssignableFrom(System.Type) */, L_40, L_41);
					if (!L_42)
					{
						goto IL_01b5_1;
					}
				}
				{
					...
					NullCheck(L_46);
					bool L_48;
					L_48 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(21 /* System.Boolean System.Type::IsAssignableFrom(System.Type) */, L_46, L_47);
					if (!L_48)
					{
						goto IL_01b5_1;
					}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TypeExtensions__cctor_mD5A68CA4BBEF6CADC657446F10C91B4A526DD43A (const RuntimeMethod* method) 
{
	...
	HashSet_1_tAE2F12E55878645F5BE7C4D5603228A6FAB429C7* V_1 = NULL;
	{
		...
		NullCheck(L_212);
		Type_t* L_213;
		L_213 = VirtualFuncInvoker0< Type_t* >::Invoke(119 /* System.Type System.Type::MakePointerType() */, L_212);
